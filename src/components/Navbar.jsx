...
const Navbar = () => {
    ...
    return (
        <header className='w-full fixed z-10 bg-fuchsia-950 opacity-90'>
            <nav className='flex w-full py-2 md:py-3 px-4 md:px-20 items-center justify-between'>
                <a href="/" className='flex items-center justify-center text-cyan-500 text-lg cursor-pointer'>
                    <img src={Logo} alt="Logo" className='hidden md:block w-8 h-8 lg:w-14 lg:h-14' />
                    India<span>Eatzz</span>
                </a>
